...
\begin{frame}{Protocol Flow Variants}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Obsolete in OAuth 2.1 draft \cite{ietf-oauth-2.1} \gray{$\to$ security drawbacks}
		\end{itemize}
...
\begin{frame}{\texttt{security-jwt} Module}
	\begin{overprint}
		\onslide<1| handout:1>
	...
	\begin{multicols}{2}
	\begin{itemize}
		\item Validating and decoding ID token
		\item Creating and updating user references
	\end{itemize}
	\end{multicols}
\end{frame}
